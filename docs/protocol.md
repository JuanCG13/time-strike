...
Returns current elapsed/remaining, mode, schedule, reserves, usable work, `max_new_action_seconds`, `next_check_seconds`, action fit and `must_*` flags. History/objective/checkpoint text is never returned.
